...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if ($action === 'login') {
        ...
        $grp->execute([$gid]);
        $g = $grp->fetch();
        if ($g && $g['type'] === 'channel') { $response['error'] = 'کانال فقط با دعوت ادمین'; }
        else {
    ...
    <div id="app">
        ...
        <aside id="sidebar">
            ...
            <nav>
                ...
                <?php endif; ?>
                <a href="index.php?action=logout" class="nav-link" target="_blank">خروج</a>
            </nav>
        ...
        <div class="group-list-all">
            ...
            <div class="group-card">
                <div>
                    ...
                    <span class="badge"><?= $g['type'] === 'channel' ? 'کانال' : 'گروه' ?></span>
...
<?php elseif ($currentGroup && isLoggedIn()): ?>
    ...
    <div class="chat-view">
        ...
        <?php else: ?>
            <p style="text-align:center;padding:10px;color:#888;">این کانال فقط خواندنی است</p>
        <?php endif; endif; ?>
    </div>
